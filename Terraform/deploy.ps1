...
Write-Host "Validation Terraform..." -ForegroundColor Yellow
terraform validate

Write-Host "Plan et Apply Terraform..." -ForegroundColor Yellow
& powershell -NoProfile -ExecutionPolicy Bypass -File "run_plan.ps1"
